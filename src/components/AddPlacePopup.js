...
const AddPlacePopup = ({ isOpen, onClose, addElement }) => {
...
//все по образцу editprofile/editAvatar
    ...
    return (
        <PopupWithForm onSubmit={onSubmit} isOpen={isOpen} onClose={onClose} title='Новое место' name='place-info'>
            <input onChange={onChange} id='input-element-name' name='name' minLength='2' maxLength='40' required type='text'
            ...
            <input onChange={onChange} id='input-element-link' name='link' type='url' required placeholder='Ссылка на картинку'
